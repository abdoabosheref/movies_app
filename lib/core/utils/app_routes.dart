...
import 'package:movies_app/core/utils/auth_screen_picker.dart';
...
class AppRoutes {
  ...
  static const String authScreenPicker = '/auth_screen_picker';
  ...
  static Map<String, Widget Function(BuildContext)> routes = {
    ...
    AppRoutes.authScreenPicker: (context) => AuthScreenPicker(),
  };
}
