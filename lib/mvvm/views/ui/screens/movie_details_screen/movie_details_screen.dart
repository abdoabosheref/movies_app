...
import '../../../../view_model/similar_movie/similar_movie_cubit.dart';
import '../../../../view_model/similar_movie/similar_movie_state.dart';
...
class MovieDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      //todo: We need the id of movie
      create: (context) => SimilarMoviesCubit()..getSimilarMovies(movie.id),
      child: Scaffold(
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [Colors.transparent, AppColors.blackOpacity70],
                      ),
                    ),
                  ),
                  SafeArea(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                "Playing ${movie.title} trailer...".tr(),
                              ),
                            ),
                          );
                        },
                ...
                child: Column(
                  children: [
                    ...
                    CustomElevatedButton(
                      ...
                      child: Text("Watch", style: AppStyles.white20BoldRoboto),
                    ),
                    const SizedBox(height: 16),
                    // Stats Row
                    Row(
             ...
             //todo: **************  Start    **************
              BlocConsumer<SimilarMoviesCubit, SimilarMoviesState>(
                ...
                builder: (context, state) {
                  ...
                  if (state is SimilarMoviesSuccess) {
                    final similarMovies = state.movies;
                    ...
                    return GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final singleMovie = similarMovies[index];
                        return CachedNetworkImage(
                          imageUrl: singleMovie.mediumCoverImage ?? '',
                          fit: BoxFit.cover,
                        ...
                        //   borderRadius: BorderRadius.circular(15),
                        //   child: Image.network(
                        //     singleMovie.mediumCoverImage ?? '',
                        //     fit: BoxFit.cover,
                        //     errorBuilder: (context, error, stackTrace) =>
                        //         Image.asset(AppAssets.watchNowImage, fit: BoxFit.cover),
                        //   ),
                        // );
                      },
                    );
              ...
              Padding(
                ...
                child: Wrap(
                  ...
                  children: movie.genres
                      .map((genre) => buildGenreChip(genre.tr()))
                      .toList(),
                ),
              ),
